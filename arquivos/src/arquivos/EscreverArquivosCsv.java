...
public class EscreverArquivosCsv {
	...
	public static void main(String[] args) throws IOException {
		...
		File arquivo = new File("C:\\\\workspace-curso-java-JDEV\\\\arquivos\\\\src\\\\arquivos\\\\arquivo.csv"); // Unica coisa que muda e o nome do arquivo
