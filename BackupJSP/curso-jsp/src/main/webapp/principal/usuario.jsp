...
<body>
							...
							<div class="main-body">
								<div class="page-wrapper">
									...
									<div class="page-body">
										...
										<span style="color: green; font-size: 30px" id="msg">${msg}</span>
	...
	<script type="text/javascript">
		...
		function buscarUsuario() {
			...
			if (nomeBusca != null && nomeBusca != '' && nomeBusca.trim() != '') { // Validando que precisa ter valor para buscar no banco de dados
				...
				$.ajax({
					...
					success : function(response) {
						...
						for(var p = 0; p < json.length; p++) {
							...
							$('#tabelaresultados > tbody').append('<td>'+ json[p].id +' </td>');
							$('#tabelaresultados > tbody').append('<td>'+ json[p].nome +' </td>');
							$('#tabelaresultados > tbody').append('<td> <button onclick="verEditar('+json[p].id+')" type="button" class="btn btn-info">Ver</button> </td>');
							$('#tabelaresultados > tbody').append('</tr>');
						}
